import {Drawer,DrawerBody,DrawerFooter,DrawerHeader,DrawerOverlay,DrawerContent,DrawerCloseButton, Button,Input,useDisclosure, FormLabel} from '@chakra-ui/react'
...
export  function UploadDrawer({image,setImage}) {
    ...
    return (
      <>
        ...
        <Button color={"rgb(115,115,115)"} bgColor={"transparent"} leftIcon={<CgAddR color='rgb(115,115,115)'/>} ref={btnRef} onClick={onOpen} minW={"full"} maxW={"100%"}>
                            Create a post
        </Button>
        <Drawer
          isOpen={isOpen}
        ...
        >
          ...
          <DrawerContent  minH={"100vh"} margin={"0px"} padding={"0px"}>
            ...
            <DrawerBody padding={"40px"} textAlign={"left"} paddingTop={"0px"} margin={"0px"} backgroundColor={"rgb(248,248,248)"} >
                ...
                <Button w="full" marginLeft={"7px"} fontSize={"1.3rem"} justifyItems={"left"} justifyContent={"left"} leftIcon={<FaCamera/>} backgroundColor={"transparent"}>Capture with Camera</Button>
            </DrawerBody>
